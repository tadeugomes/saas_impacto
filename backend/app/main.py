...
from app.api.v1.indicators import module1_router, generic_router, forecasting_router, module6_fiscal_router, module12_capacity_router
...
api_router.include_router(module12_capacity_router)
