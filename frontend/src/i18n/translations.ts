...
const messages: Record<Locale, MessageCatalog> = {
  'pt-BR': {
    ...
    'navigation.module12': 'Capacidade e Investimento',
    // Module 3 — multiplier panel
    ...
    'module12.title': 'Capacidade e Oportunidades de Investimento',
    'module12.subtitle': 'Quanto o porto consegue movimentar, onde estão os gargalos e qual a margem para crescimento',
  ...
  'en-US': {
    ...
    'navigation.module12': 'Capacity & Investment',
    // Module 3 — multiplier panel
    ...
    'module12.title': 'Capacity & Investment Opportunities',
    'module12.subtitle': 'How much the port can handle, where the bottlenecks are, and room for growth',
